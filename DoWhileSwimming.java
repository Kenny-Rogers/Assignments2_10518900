...
public class DoWhileSwimming {
    /*
        1)Yes, they do
        2)the do while loop executes once before esting the check condition
        3)GALLANT checks the condition first
        4)GOOFUS dives first
        5)the while loop executes its block of code only if its test condtion is
          met but the do while loop executes its block of code onces before it test
          its condition
        6)while loop -> pre-test loop
